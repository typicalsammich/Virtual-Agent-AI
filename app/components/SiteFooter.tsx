  ...
  return <footer className="siteFooter">
    ...
    <div className="footerMain">
      <div className="footerBrand">
        ...
        <p>A managed AI Agent system built to answer calls, qualify leads, and keep service businesses moving.</p>
      ...
      <div className="footerColumn"><h3>AI Agent Solutions</h3><a href="/services/ai-call-answering">AI Agent Call Answering</a><a href="/services/lead-qualification">AI Agent Lead Qualification</a><a href="/services/appointment-booking">AI Agent Appointment Booking</a><a href="/services/after-hours-answering">AI Agent After-Hours Coverage</a></div>
